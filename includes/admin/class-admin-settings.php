		...
		<form method="post" action="options.php">
			...
			<div class="pc-card">
				...
				$tweaks = array(
					...
					array( 'disable_xmlrpc', __( 'Disable XML-RPC', 'prime-cache' ), __( 'Disable the XML-RPC API and remove the X-Pingback header. XML-RPC is a legacy interface often targeted by brute-force attacks. Not needed if you use the REST API.', 'prime-cache' ) ),
